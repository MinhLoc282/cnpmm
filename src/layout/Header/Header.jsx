...
import NhaXinhPhongKhachHienDai from 'assets/images/nha-xinh-phong-khach-hien-dai-poppy-1-1200x800.jpg';
            ...
            <div className="flex-row container">
                ...
                <ul className="nav nav-left medium-nav-center nav-small  nav-">
                  <div className="lang">
                    <i className="image-icon">
                      <LazyLoadImage width="18" height="12" alt="Tiếng Việt" src={VIFlag} />
                      <noscript><LazyLoadImage width="18" height="12" src={VIFlag} alt="Tiếng Việt" /></noscript>
                    </i>
                    {' '}
              ...
              <div className="flex-col hide-for-medium flex-right">
                <ul className="nav top-bar-nav nav-right nav-small  nav-">
                  <li className="html custom html_topbar_right"><a href="he-thong-cua-hang/index.html" aria-label="Location"><i className="fal fa-map-marker-alt" /></a></li>
                  <li className="header-wishlist-icon">
                    <button
                      ...
                      data-color=""
                      className="is-small wishlist-link wishlist-button"
                      aria-label="Wishlist"
                  ...
                  <li className="cart-item has-icon">
                    <button type="button" onClick={openCartModal} className="header-cart-link off-canvas-toggle nav-top-link is-small cart-button" data-open="#cart-popup" data-class="off-canvas-cart" title="Cart" data-pos="right">
                      <span className="image-icon header-cart-icon" data-icon-label="0">
                        <LazyLoadImage width="20" height="20" className="cart-img-icon" alt="Cart" src={ICShopping} />
                        <noscript><LazyLoadImage width="20" height="20" className="cart-img-icon" alt="Cart" src={ICShopping} /></noscript>
                      </span>
                    </button>
            ...
            <div className="header-inner flex-row container logo-left medium-logo-center" role="navigation">
              <div id="menu-icon" className="flex-col menu-icon">
                <div className="nav-icon has-icon menu_bar desktop">
                  <button type="button" onClick={openNavbarModal} data-open="#product-categories-menu" data-pos="left" data-bg="main-menu-overlay" data-color="" className="is-small" aria-label="Menu" aria-controls="product-categories-menu" aria-expanded="false">
                    <LazyLoadImage width="30" height="22" alt="Menu bar" src={MenuBar} />
                  </button>
                </div>

                <div className="nav-icon has-icon menu_bar mobile">
                  <button type="button" onClick={openNavbarModal} data-open="#main-menu" data-pos="left" data-bg="main-menu-overlay" data-color="" className="is-small" aria-label="Menu" aria-controls="main-menu" aria-expanded="false">
                    <LazyLoadImage width="30" height="22" alt="Menu bar" src={MenuBar} />
                  </button>
                </div>
                {' '}
              ...
              <div id="logo" className="flex-col logo">
                <a href="index.html" title="Nội thất Nhà Xinh - Đồ gỗ nội thất">
                  <LazyLoadImage
                    ...
                    alt="Nội thất Nhà Xinh"
                    loading="lazy"
                    src={Logo}
                  />
                  <noscript><LazyLoadImage width="169" height="90" src={Logo} className="header_logo header-logo" alt="Nội thất Nhà Xinh" /></noscript>
                  <LazyLoadImage
                    width="169"
                    height="90"
                    ...
                    src={Logo}
                  />
                  <noscript><LazyLoadImage width="169" height="90" src={Logo} className="header-logo-dark" alt="Nội thất Nhà Xinh" /></noscript>
                ...
                <ul className="mobile-nav nav nav-left ">
                  <div className="nav-icon has-icon menu_bar desktop">
                    <a href="/" data-open="#product-categories-menu" data-pos="left" data-bg="main-menu-overlay" data-color="" className="is-small" aria-label="Menu" aria-controls="product-categories-menu" aria-expanded="false">
                      ...
                      <LazyLoadImage width="30" height="22" alt="Menu bar" src={MenuBar} />
                      <noscript><LazyLoadImage width="30" height="22" src={MenuBar} alt="Menu bar" /></noscript>
            ...
            flex-grow"
              >
                <ul className="header-nav header-nav-main nav nav-left  nav-size-medium nav-uppercase">
                  <li
                    id="menu-item-287"
                    className={`menu-item menu-item-type-post_type menu-item-object-page menu-item-287 menu-item-design-container-width menu-item-has-block has-dropdown ${
                  ...
                  >
                    ...
                    <div className="sub-menu nav-dropdown" style={isDropdownOpen ? { width: '1272px', left: '-254px' } : {}}>
                      {' '}
                              ...
                              <div className="col-inner">
                                <div className="img has-hover img_menu_mega x md-x lg-x y md-y lg-y" id="image_1349304432">
                                  <div className="img-inner dark">
                                    <LazyLoadImage width="1020" height="680" className="attachment-large size-large" alt="phòng khách hiện đại poppy" src={NhaXinhPhongKhachHienDai} />
                                    <noscript><LazyLoadImage width="1020" height="680" src={NhaXinhPhongKhachHienDai} className="attachment-large size-large" alt="phòng khách hiện đại poppy" sizes="(max-width: 1020px) 100vw, 1020px" /></noscript>
                                  </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <MenuItem id="menu-item-8010" designClass="menu-item-has-children menu-item-design-default has-dropdown">
