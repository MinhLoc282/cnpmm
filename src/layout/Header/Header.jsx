              ...
              <div className="col-md-4">
                <div className="full">
                  ...
                  <div className="logo_circle">
                    <a href="index.html">
                    <img className="img-responsive" src="/assets/img/logo.png" alt="#" /></a>
                  </div>
                </div>
              </div>
                ...
                <div className="float-right">
                  <ul className="top_links">
                    {isLoggedIn ? (
                      <div className="dropdown">
                        <button type="button" onClick={toggleDropdown}>
                          ...
                          src="/assets/images/profile_icon.png" alt="#" />
                        </button>
                        ...
                        <div className="dropdown-content">
                          <a href="/">Profile</a>
                          <a href="/">Settings</a>
                          <button className="dropdown-content-logout"
                    ...
                    <li className="searchbar">
                      ...
                      <img src="/assets/images/search_icon.png" alt="#" /></a>
                    </li>
                  </ul>
                </div>
              </div>
                  ...
                  <li className="cart-item has-icon">
                    ...
                    <a href="gio-hang/index.html" className="header-cart-link off-canvas-toggle nav-top-link is-small" data-open="#cart-popup" data-class="off-canvas-cart" title="Cart" data-pos="right">
                      ...
                      <span className="image-icon header-cart-icon" data-icon-label="0">
                        <img width="20" height="20" className="cart-img-icon" alt="Cart" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2020%2020'%3E%3C/svg%3E" data-lazy-src="wp-content/uploads/2021/09/ic-shopping.png" />
              ...
              <div id="menu-icon" className="flex-col menu-icon">
                <div className="nav-icon has-icon menu_bar desktop">
                  <a href="/" data-open="#product-categories-menu" data-pos="left" data-bg="main-menu-overlay" data-color="" className="is-small" aria-label="Menu" aria-controls="product-categories-menu" aria-expanded="false">
                    ...
                    <img width="30" height="22" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2030%2022'%3E%3C/svg%3E" alt="Menu bar" data-lazy-src="wp-content/themes/flatsome-child/assets/images/menu-bar.png" />
              ...
              <div id="logo" className="flex-col logo">
                <a href="index.html" title="Nội thất Nhà Xinh - Đồ gỗ nội thất">
                  <img
                    width="169"
                    height="90"
                    src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20169%2090'%3E%3C/svg%3E"
                    className="header_logo header-logo"
                    alt="Nội thất Nhà Xinh"
                    loading="lazy"
                    data-src="/wp-content/uploads/2022/04/logo-nha-xinh-moi-200422.png"
                  />
                              ...
                              <div className="col-inner">
                                ...
                                <div className="img has-hover img_menu_mega x md-x lg-x y md-y lg-y" id="image_1349304432">
                                  <div className="img-inner dark">
                                    <img width="1020" height="680" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201020%20680'%3E%3C/svg%3E" className="attachment-large size-large" alt="phòng khách hiện đại poppy" decoding="async" data-lazy-srcset="https://nhaxinh.com/wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1-1200x800.jpg 1200w, https://nhaxinh.com/wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1.jpg 1500w" data-lazy-sizes="(max-width: 1020px) 100vw, 1020px" data-lazy-src="wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1-1200x800.jpg" />
                                    <noscript><img width="1020" height="680" src="wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1-1200x800.jpg" className="attachment-large size-large" alt="phòng khách hiện đại poppy" decoding="async" srcSet="https://nhaxinh.com/wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1-1200x800.jpg 1200w, https://nhaxinh.com/wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2021/10/nha-xinh-phong-khach-hien-dai-poppy-1.jpg 1500w" sizes="(max-width: 1020px) 100vw, 1020px" /></noscript>
                                  </div>
                                </div>
                ...
                <ul className="mobile-nav nav nav-right huan ">
                  ...
                  <li className="cart-item has-icon">
                    ...
                    <a href="gio-hang/index.html" className="header-cart-link off-canvas-toggle nav-top-link is-small" data-open="#cart-popup" data-class="off-canvas-cart" title="Cart" data-pos="right">
                      ...
                      <span className="image-icon header-cart-icon" data-icon-label="0">
                        <img width="20" height="20" className="cart-img-icon" alt="Cart" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2020%2020'%3E%3C/svg%3E" data-lazy-src="https://nhaxinh.com/wp-content/uploads/2021/09/ic-shopping.png" />
                        <noscript><img width="20" height="20" className="cart-img-icon" alt="Cart" src="wp-content/uploads/2021/09/ic-shopping.png" /></noscript>
                      </span>
                    </a>
