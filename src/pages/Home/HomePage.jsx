      ...
      <div id="content" role="main" className="content-area">
        <div className="slider-wrapper relative hide-for-small" id="slider-609492901">
          ...
          >
            ...
            <div className="banner has-hover bg-zoom" id="banner-762721332">
              <div className="banner-inner fill">
                ...
                <div className="banner-layers container">
                  ...
                  <div id="text-box-671666854" className="text-box banner-layer x50 md-x50 lg-x50 y30 md-y30 lg-y30 res-text">
                    <div className="text-box-content text dark">

                      <div className="text-inner text-center">

                        <div id="text-3705634621" className="text">

                          <h3>BỘ SƯU TẬP MỚI COASTAL</h3>
        ...
        <div className="slider-wrapper relative slider_tet_mobile show-for-small" id="slider-919919035">
          <div
            className="slider slider-type-fade slider-nav-dots-dashes-spaced slider-nav-simple slider-nav-normal slider-nav-light slider-style-normal"
            data-flickity-options='{
            "cellAlign": "center",
            "imagesLoaded": true,
            "lazyLoad": 1,
          ...
          >
            ...
            <div className="banner has-hover banner_tet_mobile bg-zoom-fade bg-zoom is-full-height" id="banner-1980159345">
              <div className="banner-inner fill">
                <div className="banner-bg fill">
                  <div className="bg fill bg-fill " />
        ...
        <section className="section" id="section_689558828">
          <div className="bg section-bg fill bg-fill  bg-loaded" />

          <div className="section-content relative" />
        </section>

        <section className="section" id="section_759632796">
          <div className="bg section-bg fill bg-fill  bg-loaded">
          ...
          <div className="section-content relative">
            ...
            <div id="gap-883906113" className="gap-element clearfix" style={{ display: 'block', height: 'auto' }} />

            <div className="banner-grid-wrapper">
              <div id="banner-grid-994941275" className="banner-grid row row-grid row-small row-full-width" data-packery-options="">

                <div className="col grid-col large-6 grid-col-1">
                  <div className="col-inner">

                    <div className="banner has-hover" id="banner-1603689008">
                      <div className="banner-inner fill">
                        <div className="banner-bg fill">
                          <div className="bg fill bg-fill " />
                          ...
                          <div id="text-box-1171943206" className="text-box banner-layer x50 md-x50 lg-x50 y50 md-y50 lg-y50 res-text">
                            <div className="text-box-content text dark">
                              ...
                              <div className="text-inner text-center">
                                ...
                                <h3 className="uppercase"><strong>sofa</strong></h3>
                ...
                <div className="col grid-col large-3 grid-col-1-2">
                  <div className="col-inner">

                    <div className="banner has-hover" id="banner-1475762535">
                      <div className="banner-inner fill">
                        <div className="banner-bg fill">
                          <div className="bg fill bg-fill " />
                          <div className="overlay" />
                          ...
                          <div id="text-box-1929009184" className="text-box banner-layer x50 md-x50 lg-x50 y50 md-y50 lg-y50 res-text">
                            <div className="text-box-content text dark">
                              ...
                              <div className="text-inner text-center">
                                ...
                                <h3 className="uppercase"><strong>BÀN ĂN</strong></h3>
                ...
                <div className="col grid-col large-3 grid-col-1-2">
                  <div className="col-inner">
                    ...
                    <div className="banner has-hover" id="banner-361829436">
                      <div className="banner-inner fill">
                        <div className="banner-bg fill">
                          <div className="bg fill bg-fill " />
                          ...
                          <div id="text-box-1660448018" className="text-box banner-layer x50 md-x50 lg-x50 y50 md-y50 lg-y50 res-text">
                            <div className="text-box-content text dark">
                              ...
                              <div className="text-inner text-center">
                                ...
                                <h3 className="uppercase"><b>GIƯỜNG</b></h3>
                ...
                <div className="col grid-col large-3 grid-col-1-2">
                  <div className="col-inner">
                    ...
                    <div className="banner has-hover" id="banner-778942181">
                      <div className="banner-inner fill">
                        <div className="banner-bg fill">
                          <div className="bg fill bg-fill " />
                          ...
                          <div id="text-box-1696166676" className="text-box banner-layer x50 md-x50 lg-x50 y50 md-y50 lg-y50 res-text">
                            <div className="text-box-content text dark">
                              ...
                              <div className="text-inner text-center">
                                ...
                                <h3 className="uppercase"><strong>ARMCHAIR</strong></h3>
                ...
                <div className="col grid-col large-3 grid-col-1-2">
                  <div className="col-inner">
                    ...
                    <div className="banner has-hover" id="banner-1088107610">
                      <div className="banner-inner fill">
                        <div className="banner-bg fill">
                          <div className="bg fill bg-fill " />
                          ...
                          <div id="text-box-1318303730" className="text-box banner-layer x50 md-x50 lg-x50 y50 md-y50 lg-y50 res-text">
                            <div className="text-box-content text dark">
                              ...
                              <div className="text-inner text-center">
                                ...
                                <h3 className="uppercase"><b>GHẾ ĂN</b></h3>
              ...
              <form role="search" method="get" className="searchform" action="https://nhaxinh.com/">
                <div className="flex-row relative">
                  <div className="flex-col flex-grow">
                    <label className="screen-reader-text" htmlFor="woocommerce-product-search-field-2">Search for:</label>
                    <input type="search" id="woocommerce-product-search-field-2" className="search-field mb-0" placeholder="Tìm sản phẩm" value="" name="s" />
        ...
        <section className="section" id="section_1752696899">
          <div className="bg section-bg fill bg-fill  bg-loaded" />

          <div className="section-content relative">

            <div className="row row-collapse row-full-width align-equal design_air" id="row-867160168">

              <div id="col-1134659140" className="col img_first_left medium-6 small-12 large-6">
                <div className="col-inner">
                  ...
                  <div id="text-1269554617" className="text ct_design">

                    <h1 className="hidden">Nhà Xinh – Nội thất cao cấp cho không gian tinh tế</h1>
              ...
              <div id="col-1904109714" className="col first_right medium-6 small-12 large-6">
                <div className="col-inner">
            ...
            <div className="row secon_design" id="row-1527177608">
              ...
              <div id="col-1733784116" className="col secon_right medium-6 small-12 large-6">
                <div className="col-inner">
        ...
        <div className="row row-collapse row-full-width align-middle" id="row-1809592033">
          ...
          <div id="col-398052187" className="col medium-6 small-12 large-6">
            <div className="col-inner text-center" style={{ maxWidth: '520px' }}>
          ...
          <div id="col-1137022244" className="col medium-6 small-12 large-6">
            <div className="col-inner">

              <div className="img has-hover x md-x lg-x y md-y lg-y" id="image_506014236">
                <div className="img-inner dark">
                  <img decoding="async" width="1020" height="680" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20680%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/05/nha-xinh-thiet-ke-noi-that-ecopark-16523-1200x800.jpg" className="lazy-load attachment-large size-large" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/05/nha-xinh-thiet-ke-noi-that-ecopark-16523-1200x800.jpg 1200w, https://nhaxinh.com/wp-content/uploads/2023/05/nha-xinh-thiet-ke-noi-that-ecopark-16523-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2023/05/nha-xinh-thiet-ke-noi-that-ecopark-16523-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/05/nha-xinh-thiet-ke-noi-that-ecopark-16523-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2023/05/nha-xinh-thiet-ke-noi-that-ecopark-16523.jpg 1470w" sizes="(max-width: 1020px) 100vw, 1020px" />
                </div>
        ...
        <div id="gap-1752626467" className="gap-element clearfix" style={{ display: 'block', height: 'auto' }} />

        <div className="banner has-hover bg-zoom is-full-height" id="banner-1674203706">
          <div className="banner-inner fill">
            <div className="banner-bg fill">
              <div className="bg fill bg-fill " />
            ...
            <div className="banner-layers container">
              ...
              <div id="text-box-697698869" className="text-box banner-layer x15 md-x15 lg-x15 y10 md-y10 lg-y10 res-text">
                <div className="text-box-content text dark">

                  <div className="text-inner text-center">

                    <div id="text-2314744426" className="text">

                      <h2 className="uppercase"><strong>CỬA HÀNG 360 ĐỘ</strong></h2>
                      <p>
                        Trải nghiệm ngay sản phẩm của Nhà Xinh một
                        cách chân thực trên tay bạn. Tham quan, xem
                        thông tin sản phẩm chi tiết với góc nhìn 360 độ hoàn chỉnh.
                      </p>
        ...
        <div className="container section-title-container" style={{ marginTop: '50px' }}>
        ...
        <div className="row large-columns-4 medium-columns-3 small-columns-2 row-small slider row-slider slider-nav-reveal slider-nav-push" data-flickity-options='{"imagesLoaded": true, "groupCells": "100%", "dragThreshold" : 5, "cellAlign": "left","wrapAround": true,"prevNextButtons": true,"percentPosition": true,"pageDots": false, "rightToLeft": false, "autoPlay" : 5000}' data-rows="1" data-columns="4">

          <div className="col">

            <div className="product-small col has-hover product type-product post-52141 status-publish first instock product_cat-bep product_cat-ghe-an product_cat-phong-an has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                    ...
                    <div className="sub-title-wrapper">
                      ...
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div
                            className="yith-wcwl-add-to-wishlist add-to-wishlist-52141  wishlist-fragment on-first-load"
                            data-fragment-ref="52141"
                            data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:false,&quot;show_exists&quot;:false,&quot;product_id&quot;:52141,&quot;parent_product_id&quot;:52141,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:false,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}"
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div className="col">
            ...
            <div className="product-small col has-hover out-of-stock product type-product post-51932 status-publish outofstock product_cat-sofa product_tag-go has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                    ...
                    <div className="sub-title-wrapper">
                      ...
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div
                            className="yith-wcwl-add-to-wishlist add-to-wishlist-51932  wishlist-fragment on-first-load"
                            data-fragment-ref="51932"
                            data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:false,&quot;show_exists&quot;:false,&quot;product_id&quot;:51932,&quot;parent_product_id&quot;:51932,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:false,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}"
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div className="col">
            ...
            <div className="product-small col has-hover out-of-stock product type-product post-51927 status-publish outofstock product_cat-armchair product_cat-sofa product_tag-go product_tag-vai has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                    ...
                    <div className="sub-title-wrapper">
                      ...
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div
                            className="yith-wcwl-add-to-wishlist add-to-wishlist-51927  wishlist-fragment on-first-load"
                            data-fragment-ref="51927"
                            data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:false,&quot;show_exists&quot;:false,&quot;product_id&quot;:51927,&quot;parent_product_id&quot;:51927,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:false,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}"
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div className="col">
            ...
            <div className="product-small col has-hover product type-product post-51554 status-publish last instock product_cat-ban-lam-viec product_cat-phong-lam-viec has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                    ...
                    <div className="sub-title-wrapper">
                      ...
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div
                            className="yith-wcwl-add-to-wishlist add-to-wishlist-51554  wishlist-fragment on-first-load"
                            data-fragment-ref="51554"
                            data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:false,&quot;show_exists&quot;:false,&quot;product_id&quot;:51554,&quot;parent_product_id&quot;:51554,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:false,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}"
                          />
                        </div>
                      </div>
                    </div>
        ...
        <div id="product-grid-1723997034" className="row large-columns-4 medium-columns-3 small-columns-2 row-small row-masonry" data-packery-options='{"itemSelector": ".col", "gutter": 0, "presentageWidth" : true}' data-rows="1" data-columns="4">

          <div className="col">

            <div className="product-small col has-hover product type-product post-52144 status-publish first instock product_cat-giuong product_cat-phong-ngu has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                    ...
                    <div className="sub-title-wrapper">
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div
                            className="yith-wcwl-add-to-wishlist add-to-wishlist-52144  wishlist-fragment on-first-load"
                            data-fragment-ref="52144"
                            data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:false,&quot;show_exists&quot;:false,&quot;product_id&quot;:52144,&quot;parent_product_id&quot;:52144,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:false,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}"
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div className="col">
            ...
            <div className="product-small col has-hover product type-product post-52143 status-publish instock product_cat-ban-lam-viec product_cat-phong-lam-viec has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                    ...
                    <div className="sub-title-wrapper">
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div
                            className="yith-wcwl-add-to-wishlist add-to-wishlist-52143  wishlist-fragment on-first-load"
                            data-fragment-ref="52143"
                            data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:false,&quot;show_exists&quot;:false,&quot;product_id&quot;:52143,&quot;parent_product_id&quot;:52143,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:false,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}"
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div className="col">
            ...
            <div className="product-small col has-hover product type-product post-51937 status-publish instock product_cat-phong-khach product_cat-tu-tivi has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
          ...
          <div className="col">
            ...
            <div className="product-small col has-hover product type-product post-51550 status-publish last instock product_cat-ban-lam-viec product_cat-phong-lam-viec has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                    ...
                    <div className="sub-title-wrapper">
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div
                            className="yith-wcwl-add-to-wishlist add-to-wishlist-51550  wishlist-fragment on-first-load"
                            data-fragment-ref="51550"
                            data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:false,&quot;show_exists&quot;:false,&quot;product_id&quot;:51550,&quot;parent_product_id&quot;:51550,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:false,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}"
                          />
                        </div>
                      </div>
                    </div>
        ...
        <div className="row large-columns-4 medium-columns-3 small-columns-2 row-small slider row-slider slider-nav-reveal slider-nav-push" data-flickity-options='{"imagesLoaded": true, "groupCells": "100%", "dragThreshold" : 5, "cellAlign": "left","wrapAround": true,"prevNextButtons": true,"percentPosition": true,"pageDots": false, "rightToLeft": false, "autoPlay" : false}' data-rows="1" data-columns="4">

          <div className="col">

            <div className="product-small col has-hover product type-product post-53924 status-publish first instock product_cat-sofa product_tag-vat-lieu-da product_tag-go has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                    ...
                    <div className="sub-title-wrapper">
                      ...
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div
                            className="yith-wcwl-add-to-wishlist add-to-wishlist-53924  wishlist-fragment on-first-load"
                            data-fragment-ref="53924"
                            data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:false,&quot;show_exists&quot;:false,&quot;product_id&quot;:53924,&quot;parent_product_id&quot;:53924,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:false,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}"
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div className="col">
            ...
            <div className="product-small col has-hover product type-product post-53922 status-publish instock product_cat-sofa product_tag-vat-lieu-da product_tag-go has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                    ...
                    <div className="sub-title-wrapper">
                      ...
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div
                            className="yith-wcwl-add-to-wishlist add-to-wishlist-53922  wishlist-fragment on-first-load"
                            data-fragment-ref="53922"
          ...
          <div className="col">
            ...
            <div className="product-small col has-hover product type-product post-53907 status-publish instock product_cat-armchair product_cat-sofa product_tag-vat-lieu-da product_tag-go has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                    ...
                    <div className="sub-title-wrapper">
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div
                            className="yith-wcwl-add-to-wishlist add-to-wishlist-53907  wishlist-fragment on-first-load"
                            data-fragment-ref="53907"
                            data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:false,&quot;show_exists&quot;:false,&quot;product_id&quot;:53907,&quot;parent_product_id&quot;:53907,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:false,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}"
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div className="col">
            ...
            <div className="product-small col has-hover product type-product post-53904 status-publish last instock product_cat-armchair product_cat-sofa product_tag-vat-lieu-da product_tag-go has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
              <div className="col-inner">
                      ...
                      <div className="wishlist-icon">
                        ...
                        <div className="wishlist-popup dark">
                          <div
                            ...
                            data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:false,&quot;show_exists&quot;:false,&quot;product_id&quot;:53904,&quot;parent_product_id&quot;:53904,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:false,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}"
                          />
                        </div>
                      </div>
                    </div>
        ...
        <div id="gap-2113667135" className="gap-element clearfix" style={{ display: 'block', height: 'auto' }} />

        <div className="banner has-hover bg-zoom" id="banner-1950404152">
          <div className="banner-inner fill">
            <div className="banner-bg fill">
              <div className="bg fill bg-fill " />
            ...
            <div className="banner-layers container">
              ...
              <div id="text-box-1028103647" className="text-box banner-layer x75 md-x75 lg-x75 y5 md-y5 lg-y5 res-text">
                <div className="text-box-content text dark">

                  <div className="text-inner text-center">

                    <div id="text-221784697" className="text">
          ...
          <div className="height-fix is-invisible"><img decoding="async" width="1800" height="1200" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201800%201200%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2022/04/giuong-iris-dep-gia-tot-hoc-keo.jpg" className="lazy-load attachment-original size-original" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2022/04/giuong-iris-dep-gia-tot-hoc-keo.jpg 1800w, https://nhaxinh.com/wp-content/uploads/2022/04/giuong-iris-dep-gia-tot-hoc-keo-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2022/04/giuong-iris-dep-gia-tot-hoc-keo-1200x800.jpg 1200w, https://nhaxinh.com/wp-content/uploads/2022/04/giuong-iris-dep-gia-tot-hoc-keo-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2022/04/giuong-iris-dep-gia-tot-hoc-keo-1536x1024.jpg 1536w, https://nhaxinh.com/wp-content/uploads/2022/04/giuong-iris-dep-gia-tot-hoc-keo-300x200.jpg 300w" sizes="(max-width: 1800px) 100vw, 1800px" /></div>

        </div>

        <div id="gap-1895576768" className="gap-element clearfix" style={{ display: 'block', height: 'auto' }} />

        <div id="gap-1509444521" className="gap-element clearfix" style={{ display: 'block', height: 'auto' }} />

        <div className="container section-title-container" style={{ marginTop: '80px' }}>
          <h3 className="section-title section-title-normal">
            <b />
            <span className="section-title-main">Sản phẩm vừa xem</span>
            <b />
          </h3>
        </div>

        <div className="row product_list empty-post large-columns-4 medium-columns-3 small-columns-2 row-small show-viewed-recently slider row-slider slider-nav-reveal slider-nav-push" data-flickity-options='{"imagesLoaded": true, "groupCells": "100%", "dragThreshold" : 5, "cellAlign": "left","wrapAround": true,"prevNextButtons": true,"percentPosition": true,"pageDots": false, "rightToLeft": false, "autoPlay" : false}' data-rows="1" data-columns="4" />

        <div className="container section-title-container title_goccamhung" style={{ marginTop: '74px', marginBottom: '26px' }}>
          <h3 className="section-title section-title-center">
            <b />
            <span className="section-title-main">Góc cảm hứng</span>
            <b />
          </h3>
        </div>

        <div className="row large-columns-2 medium-columns- small-columns-1 row-xsmall slider row-slider slider-nav-simple slider-nav-outside slider-nav-light slider-nav-push" data-flickity-options='{"imagesLoaded": true, "groupCells": "100%", "dragThreshold" : 5, "cellAlign": "left","wrapAround": false,"prevNextButtons": true,"percentPosition": true,"pageDots": true, "rightToLeft": false, "autoPlay" : false}'>
                ...
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Bàn Wing &#8211; lựa chọn hoàn hảo cho không gian làm việc</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Phòng làm việc là không gian tiếp thêm năng lượng để chúng ta sáng tạo và phát triển. Lựa chọn [...]</p>
                ...
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Đến Nhà Xinh, chọn quà tinh tế</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Mỗi món quà trao đi, gói trọn muôn vàn thành ý từ người tặng gửi đến người nhận. Đặc biệt [...]</p>
                ...
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Phân loại và gợi ý cách chọn đèn trang trí</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Dù là phòng khách, phòng ngủ, phòng ăn hay phòng làm việc thì đèn trang trí đều là sản phẩm [...]</p>
                ...
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Nghệ thuật chọn đèn trang trí cho không gian hiện đại</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Đèn trang trí không chỉ là nguồn sáng cho ngôi nhà, mà còn là một phần quan trọng cho trải [...]</p>
            ...
            <div className="col-inner">
              <a href="/tao-lap-phong-an-chat-luong-voi-5-cach-don-gian" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="1020" height="612" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20612%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2022/07/ban-an-peak-hien-dai-van-may-ceramic-22-1333x800.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="Bàn ăn Peak hiện đại vân may ceramic sang trọng" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2022/07/ban-an-peak-hien-dai-van-may-ceramic-22-1333x800.jpg 1333w, https://nhaxinh.com/wp-content/uploads/2022/07/ban-an-peak-hien-dai-van-may-ceramic-22-667x400.jpg 667w, https://nhaxinh.com/wp-content/uploads/2022/07/ban-an-peak-hien-dai-van-may-ceramic-22-768x461.jpg 768w, https://nhaxinh.com/wp-content/uploads/2022/07/ban-an-peak-hien-dai-van-may-ceramic-22-300x180.jpg 300w, https://nhaxinh.com/wp-content/uploads/2022/07/ban-an-peak-hien-dai-van-may-ceramic-22-600x360.jpg 600w, https://nhaxinh.com/wp-content/uploads/2022/07/ban-an-peak-hien-dai-van-may-ceramic-22.jpg 1350w" sizes="(max-width: 1020px) 100vw, 1020px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Tạo lập phòng ăn chất lượng với 5 cách đơn giản</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Phòng ăn là không gian kết nối và thư giãn của mỗi gia đình, nơi các thành viên tận hưởng [...]</p>
            ...
            <div className="col-inner">
              <a href="/noi-that-go-soi-su-giao-thoa-cua-ve-dep-va-chat-luong-2" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="1020" height="614" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20614%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/10/phong-khach-penny-10-1328x800.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/10/phong-khach-penny-10-1328x800.jpg 1328w, https://nhaxinh.com/wp-content/uploads/2023/10/phong-khach-penny-10-664x400.jpg 664w, https://nhaxinh.com/wp-content/uploads/2023/10/phong-khach-penny-10-768x463.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/10/phong-khach-penny-10-1536x925.jpg 1536w, https://nhaxinh.com/wp-content/uploads/2023/10/phong-khach-penny-10-300x181.jpg 300w, https://nhaxinh.com/wp-content/uploads/2023/10/phong-khach-penny-10-600x361.jpg 600w, https://nhaxinh.com/wp-content/uploads/2023/10/phong-khach-penny-10.jpg 1800w" sizes="(max-width: 1020px) 100vw, 1020px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Mang làn gió Lagom đến không gian sống của bạn</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Lagom, một thuật ngữ không còn quá xa lạ với nhiều người. Lagom bắt nguồn từ Thụy Điển, một trong [...]</p>
            ...
            <div className="col-inner">
              <a href="/noi-that-go-soi-su-giao-thoa-cua-ve-dep-va-chat-luong" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="1020" height="654" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20654%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/10/bridge-1247x800.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/10/bridge-1247x800.jpg 1247w, https://nhaxinh.com/wp-content/uploads/2023/10/bridge-623x400.jpg 623w, https://nhaxinh.com/wp-content/uploads/2023/10/bridge-768x493.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/10/bridge-1536x986.jpg 1536w, https://nhaxinh.com/wp-content/uploads/2023/10/bridge-300x193.jpg 300w, https://nhaxinh.com/wp-content/uploads/2023/10/bridge-600x385.jpg 600w, https://nhaxinh.com/wp-content/uploads/2023/10/bridge.jpg 1700w" sizes="(max-width: 1020px) 100vw, 1020px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Nội thất gỗ sồi &#8211; sự giao thoa của vẻ đẹp và chất lượng</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Ngày nay, xu hướng tìm về với vẻ đẹp đơn giản, bền vững, gần gũi với thiên nhiên càng trở [...]</p>
                ...
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Những ý tưởng trang trí phòng khách nổi bật</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Không gian phòng khách là điểm nhấn của cả ngôi nhà. Vì vậy, ai cũng mong muốn một thiết kế [...]</p>
        ...
        <div id="gap-847868558" className="gap-element clearfix" style={{ display: 'block', height: 'auto' }} />

        <div id="gap-123179871" className="gap-element clearfix" style={{ display: 'block', height: 'auto' }}>

          <style />
        </div>

        <section className="section dark" id="section_635179170">
          <div className="bg section-bg fill bg-fill  bg-loaded">
          ...
          <div className="section-content relative">
            ...
            <div className="row row-collapse row-full-width align-middle" id="row-1883741332">

              <div id="col-1988428650" className="col medium-6 small-12 large-6">
                <div className="col-inner text-left" style={{ maxWidth: '520px' }}>

                  <div id="text-2368726676" className="text">

                    <h2 style={{ textAlign: 'left' }}><strong>Tổ ấm của người tinh tế</strong></h2>
                    <p style={{ textAlign: 'left' }}>Trong suốt hơn 22 năm qua, cảm hứng từ gu thẩm mỹ tinh tế và tinh thần &#8220;Việt&#8221; đã giúp Nhà Xinh tạo ra những thiết kế độc đáo, hợp thời và chất lượng. Nhà Xinh hiện đã mở 10 cửa hàng tại Việt Nam.</p>
              ...
              <div id="col-309999998" className="col medium-6 small-12 large-6">
                <div className="col-inner">

                  <div className="img has-hover x md-x lg-x y md-y lg-y" id="image_2096296992">
                    <div className="img-inner dark">
                      <img decoding="async" width="1020" height="680" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20680%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2022/07/gioi-thieu-nha-xinh-moi-25-7-22-1200x800.jpg" className="lazy-load attachment-large size-large" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2022/07/gioi-thieu-nha-xinh-moi-25-7-22-1200x800.jpg 1200w, https://nhaxinh.com/wp-content/uploads/2022/07/gioi-thieu-nha-xinh-moi-25-7-22-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2022/07/gioi-thieu-nha-xinh-moi-25-7-22-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2022/07/gioi-thieu-nha-xinh-moi-25-7-22-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2022/07/gioi-thieu-nha-xinh-moi-25-7-22.jpg 1500w" sizes="(max-width: 1020px) 100vw, 1020px" />
                    </div>
        ...
        <div className="container section-title-container title_goccamhung" style={{ marginTop: '63px', marginBottom: '20px' }}>
          <h3 className="section-title section-title-center">
            <b />
            <span className="section-title-main">Chuyện Nhà Xinh</span>
            <b />
          </h3>
        </div>
            ...
            <div className="col-inner">
              <a href="/chien-luoc-phu-dong-cua-cong-ty-dung-sau-thuong-hieu-nha-xinh" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="860" height="574" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20860%20574%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/10/chien-luoc-phu-dong.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/10/chien-luoc-phu-dong.jpg 860w, https://nhaxinh.com/wp-content/uploads/2023/10/chien-luoc-phu-dong-599x400.jpg 599w, https://nhaxinh.com/wp-content/uploads/2023/10/chien-luoc-phu-dong-768x513.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/10/chien-luoc-phu-dong-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2023/10/chien-luoc-phu-dong-600x400.jpg 600w" sizes="(max-width: 860px) 100vw, 860px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Chiến lược &#8220;Phù Đổng&#8221; của công ty đứng sau thương hiệu Nhà Xinh</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Không những làm nội thất cho hàng loạt công trình nổi tiếng trong nước như Landmark 81, JW Marriott Phú [...]</p>
            ...
            <div className="col-inner">
              <a href="/design-talk-2-gap-go-nha-thiet-ke-nguyen-dinh-hoa" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="1020" height="681" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20681%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/10/design-talk-2-11-1199x800.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/10/design-talk-2-11-1199x800.jpg 1199w, https://nhaxinh.com/wp-content/uploads/2023/10/design-talk-2-11-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2023/10/design-talk-2-11-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/10/design-talk-2-11-1536x1025.jpg 1536w, https://nhaxinh.com/wp-content/uploads/2023/10/design-talk-2-11-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2023/10/design-talk-2-11.jpg 1700w" sizes="(max-width: 1020px) 100vw, 1020px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Design Talk 2 &#8211; Gặp gỡ Nhà thiết kế Nguyễn Đình Hòa</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Design Talk là hoạt động giao lưu trò chuyện được AKA tổ chức thường xuyên, gồm những buổi trao đổi [...]</p>
            ...
            <div className="col-inner">
              <a href="/design-talk-1-chuyen-tro-ve-nhung-xu-huong-noi-that" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="1020" height="554" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20554%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/10/dao-tao-02-8-1400x760.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/10/dao-tao-02-8-1400x760.jpg 1400w, https://nhaxinh.com/wp-content/uploads/2023/10/dao-tao-02-8-737x400.jpg 737w, https://nhaxinh.com/wp-content/uploads/2023/10/dao-tao-02-8-768x417.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/10/dao-tao-02-8-1536x834.jpg 1536w, https://nhaxinh.com/wp-content/uploads/2023/10/dao-tao-02-8-300x163.jpg 300w, https://nhaxinh.com/wp-content/uploads/2023/10/dao-tao-02-8-600x326.jpg 600w, https://nhaxinh.com/wp-content/uploads/2023/10/dao-tao-02-8.jpg 1699w" sizes="(max-width: 1020px) 100vw, 1020px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Design Talk 1 &#8211; Chuyện trò về những xu hướng nội thất</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Cuối tuần vừa qua, tập thể AKA đã hân hạnh đón chào một nhà thiết kế quen thuộc, người mà [...]</p>
            ...
            <div className="col-inner">
              <a href="/quy-trinh-boc-nem-sofa-da-cao-cap-khung-go" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="1020" height="680" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20680%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/09/quy-trinh-boc-sofa-da-khung-go-1200x800.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/09/quy-trinh-boc-sofa-da-khung-go-1200x800.jpg 1200w, https://nhaxinh.com/wp-content/uploads/2023/09/quy-trinh-boc-sofa-da-khung-go-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2023/09/quy-trinh-boc-sofa-da-khung-go-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/09/quy-trinh-boc-sofa-da-khung-go-1536x1024.jpg 1536w, https://nhaxinh.com/wp-content/uploads/2023/09/quy-trinh-boc-sofa-da-khung-go-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2023/09/quy-trinh-boc-sofa-da-khung-go.jpg 1700w" sizes="(max-width: 1020px) 100vw, 1020px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Quy trình bọc nệm sofa da cao cấp khung gỗ</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Tại sao có những bộ sofa luôn tạo cảm giác êm ái cho người dùng? Liệu quy trình hoàn thiện [...]</p>
            ...
            <div className="col-inner">
              <a href="/den-nha-xinh-tro-chuyen-ve-hanh-trinh-sang-tao" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="1020" height="680" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20680%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/08/hanh-trinh-sang-tao-11-1200x800.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/08/hanh-trinh-sang-tao-11-1200x800.jpg 1200w, https://nhaxinh.com/wp-content/uploads/2023/08/hanh-trinh-sang-tao-11-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2023/08/hanh-trinh-sang-tao-11-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/08/hanh-trinh-sang-tao-11-1536x1024.jpg 1536w, https://nhaxinh.com/wp-content/uploads/2023/08/hanh-trinh-sang-tao-11-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2023/08/hanh-trinh-sang-tao-11.jpg 1700w" sizes="(max-width: 1020px) 100vw, 1020px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Đến Nhà Xinh trò chuyện về hành trình sáng tạo</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Cuối tuần vừa qua, Nhà Xinh Phú Mỹ Hưng hân hạnh được chào đón diễn giả Trần Đình Thông cùng [...]</p>
            ...
            <div className="col-inner">
              <a href="/chiem-nguong-aa-tay-ninh-nha-may-san-xuat-noi-that-hien-dai-voi-quy-mo-50ha" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="1020" height="680" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20680%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/08/AA-Tay-Ninh-1200x800.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/08/AA-Tay-Ninh-1200x800.jpg 1200w, https://nhaxinh.com/wp-content/uploads/2023/08/AA-Tay-Ninh-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2023/08/AA-Tay-Ninh-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/08/AA-Tay-Ninh-1536x1024.jpg 1536w, https://nhaxinh.com/wp-content/uploads/2023/08/AA-Tay-Ninh-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2023/08/AA-Tay-Ninh.jpg 1700w" sizes="(max-width: 1020px) 100vw, 1020px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Chiêm ngưỡng AA Tây Ninh &#8211; nhà máy sản xuất nội thất hiện đại với quy mô 50ha</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Là một thành viên của tập đoàn AA, nhà máy AA Tây Ninh tọa lạc tại huyện Trảng Bàng, thành [...]</p>
            ...
            <div className="col-inner">
              <a href="/kham-pha-quy-trinh-tao-ra-san-pham-bridge-va-elegance" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="1020" height="680" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20680%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/08/quy-trinh-tao-san-pham-15-1200x800.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/08/quy-trinh-tao-san-pham-15-1200x800.jpg 1200w, https://nhaxinh.com/wp-content/uploads/2023/08/quy-trinh-tao-san-pham-15-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2023/08/quy-trinh-tao-san-pham-15-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/08/quy-trinh-tao-san-pham-15-1536x1024.jpg 1536w, https://nhaxinh.com/wp-content/uploads/2023/08/quy-trinh-tao-san-pham-15-2048x1365.jpg 2048w, https://nhaxinh.com/wp-content/uploads/2023/08/quy-trinh-tao-san-pham-15-300x200.jpg 300w" sizes="(max-width: 1020px) 100vw, 1020px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Khám phá quy trình tạo ra sản phẩm Bridge và Elegance</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Bridge và Elegance là hai dòng sản phẩm do nhà thiết kế Đan Mạch – Hans Sandgren Jakobsen tạo ra, [...]</p>
            ...
            <div className="col-inner">
              <a href="/the-gioi-sac-mau-trong-toa-dam-sac-son" className="plain">
                <div className="box box-normal box-text-bottom box-blog-post has-hover">
                  <div className="box-image">
                    <div className="image-overlay-remove image-cover" style={{ paddingTop: '56%' }}>
                      <img decoding="async" width="1020" height="680" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201020%20680%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" data-src="https://nhaxinh.com/wp-content/uploads/2023/07/toa-dam-sac-son-9.jpg" className="lazy-load attachment-large size-large wp-post-image" alt="" srcSet="" data-srcset="https://nhaxinh.com/wp-content/uploads/2023/07/toa-dam-sac-son-9.jpg 1200w, https://nhaxinh.com/wp-content/uploads/2023/07/toa-dam-sac-son-9-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2023/07/toa-dam-sac-son-9-768x512.jpg 768w, https://nhaxinh.com/wp-content/uploads/2023/07/toa-dam-sac-son-9-300x200.jpg 300w" sizes="(max-width: 1020px) 100vw, 1020px" />
                      {' '}
                      <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.09)' }} />
                      {' '}
                  ...
                  <div className="box-text show-on-hover hover-bounce text-center is-small">
                    <div className="box-text-inner blog-post-inner">
                      ...
                      <h4 className="post-title is-larger ">Thế giới sắc màu trong tọa đàm &#8220;Sắc &#8211; Son&#8221;</h4>
                      <div className="is-divider" />
                      <p className="from_the_blog_excerpt ">Cuối tuần qua, buổi tọa đàm Sắc - Son diễn ra tại Nhà Xinh Hai Bà Trưng đã thu hút [...]</p>
        ...
        <div className="row row-collapse row-full-width bg_footer" id="row-728544454">
          ...
          <div id="col-1949882766" className="col small-12 large-12">
            <div className="col-inner text-center">

              <div className="message-box relative bg_footer dark">
                <div data-bg="https://nhaxinh.com/wp-content/uploads/2021/11/cua-hang-nha-xinh-191121-1400x690.jpg" className="message-box-bg-image bg-fill fill rocket-lazyload" />
                <div className="message-box-bg-overlay bg-fill fill" style={{ backgroundColor: 'rgba(0, 0, 0, 0.366)' }} />
                <div className="container relative">
                  <div className="inner last-reset">

                    <div className="row row-collapse align-middle align-center" id="row-552821158">

                      <div id="col-714970814" className="col small-12 large-12">
                        <div className="col-inner">
                      ...
                      <div id="col-2064373282" className="col medium-4 small-12 large-4">
                        <div className="col-inner" />
                      </div>

                      <div id="col-1373987456" className="col medium-4 small-12 large-4">
                        <div className="col-inner" />
                      </div>
