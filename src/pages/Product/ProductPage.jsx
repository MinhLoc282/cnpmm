    ...
    <>
      ...
      <main id="main">
        ...
        <div className="shop-container">
          ...
          <div id="product-34192" className="product type-product post-34192 status-publish first instock product_cat-phong-khach product_cat-sofa has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
                ...
                <div className="row content-row mb-0">
                  <div className="product-gallery col large-7">
                    <div className="row row-small">
                      <div className="col large-10">
                        <div className="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images relative mb-half has-hover" data-columns="4" style={{ opacity: '1' }}>
                          ...
                          <figure
                            ...
                            // tabIndex="0"
                          >
                            <div className="flickity-viewport" style={{ height: '400px', touchAction: 'pan-y' }}>
                              <div className="flickity-slider" style={{ left: '0px', transform: 'translateX(-100%)' }}>
                                <div
                                  data-thumb="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-100x100.jpg"
                                  className="woocommerce-product-gallery__image slide first"
                                  style={{ position: 'absolute', left: '0%' }}
                                  aria-hidden="true"
                                >
                                  <a
                                    aria-label="image"
                                    href="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam.jpg"
                                  >
                                    <img
                                      width="600"
                                      height="400"
                                      src="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam.jpg"
                                      className="wp-post-image skip-lazy lazy-load-active"
                                      alt=""
                                      title="Sofa-Miami-2-cho-vai-xam"
                                      data-caption=""
                                      data-src="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam.jpg"
                                      data-large_image="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam.jpg"
                                      data-large_image_width="1000"
                                      data-large_image_height="666"
                                      decoding="async"
                                      srcSet="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-601x400.jpg 601w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-768x511.jpg 768w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam.jpg 1000w"
                                ...
                                <div
                                  data-thumb="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-100x100.jpg"
                                  className="woocommerce-product-gallery__image slide is-selected"
                                  style={{ position: 'absolute', left: '100%' }}
                                >
                                  <a
                                    aria-label="image"
                                    href="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1.jpg"
                                  >
                                    <img
                                      width="600"
                                      height="400"
                                      src="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1.jpg"
                                      className="skip-lazy lazy-load-active"
                                      alt="Sofa Miami 2 chỗ cải xám màu xanh nhạt nhẹ nhàng"
                                      title="Sofa-Miami-2-cho-vai-xam-1"
                                      data-caption=""
                                      data-src="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1.jpg"
                                      data-large_image="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1.jpg"
                                      data-large_image_width="1000"
                                      data-large_image_height="666"
                                      decoding="async"
                                      srcSet="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-601x400.jpg 601w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-768x511.jpg 768w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1.jpg 1000w"
                                      data-srcset="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-601x400.jpg 601w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-768x511.jpg 768w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1.jpg 1000w"
                                      sizes="(max-width: 600px) 100vw, 600px"
                                    />
                                  </a>
                                ...
                                <div
                                  data-thumb="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2-100x100.jpg"
                                ...
                                >
                                  <a
                                    aria-label="image"
                                    href="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2.jpg"
                                  >
                                    <img
                                      width="600"
                                      height="400"
                                      ...
                                      alt=""
                                      title="Sofa-Miami-2-cho-vai-xam-2"
                                      data-caption=""
                                      data-src="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2.jpg"
                                      data-large_image="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2.jpg"
                                      data-large_image_width="1000"
                                      data-large_image_height="666"
                                      decoding="async"
                                      srcSet=""
                                      data-srcset="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2-600x400.jpg 600w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2-601x400.jpg 601w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2-768x511.jpg 768w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2-300x200.jpg 300w, https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2.jpg 1000w"
                                      sizes="(max-width: 600px) 100vw, 600px"
                                    />
                                  </a>
                                </div>
                            ...
                            <button className="flickity-button flickity-prev-next-button previous" type="button" aria-label="Previous"><svg className="flickity-button-icon" viewBox="0 0 100 100"><path d="M 10,50 L 60,100 L 70,90 L 30,50  L 70,10 L 60,0 Z" className="arrow" /></svg></button>
                            <button className="flickity-button flickity-prev-next-button next" type="button" aria-label="Next"><svg className="flickity-button-icon" viewBox="0 0 100 100"><path d="M 10,50 L 60,100 L 70,90 L 30,50  L 70,10 L 60,0 Z" className="arrow" transform="translate(100, 100) rotate(180) " /></svg></button>
                          </figure>
                      ...
                      <div className="col large-2 large-col-first vertical-thumbnails pb-0">
                        <a href="/" data-flickity-el=".product-gallery-slider" data-action="previous" className="prev_arrow desktop"><img src="https://nhaxinh.com/wp-content/themes/flatsome-child/assets/images/arrowdown.svg" alt="preview" /></a>
                        <div
                          className="product-thumbnails thumbnails slider-no-arrows slider row row-small row-slider slider-nav-small small-columns-4 is-draggable flickity-enabled slider-lazy-load-active"
                          data-flickity-options="{
                          &quot;cellAlign&quot;: &quot;left&quot;,
                          &quot;wrapAround&quot;: false,
                          &quot;autoPlay&quot;: false,
                        ...
                        >
                          ...
                          <div className="flickity-viewport" style={{ height: '89.4688px', touchAction: 'pan-y' }}>
                            <div className="flickity-slider" style={{ left: '0px', transform: 'translateX(-96.59%)' }}>
                              <div className="col first" style={{ position: 'absolute', left: '0%' }} aria-hidden="true">
                                <a href="/">
                                  <img src="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-300x200.jpg" alt="" width="300" height="" className="attachment-woocommerce_thumbnail" />
                                </a>
                              </div>
                              <div className="col is-selected is-nav-selected" style={{ position: 'absolute', left: '95,79%' }}><a><img src="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-300x200.jpg" data-src="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-1-300x200.jpg" alt="Sofa Miami 2 chỗ cải xám màu xanh nhạt nhẹ nhàng" width="300" height="" className="attachment-woocommerce_thumbnail lazy-load-active" /></a></div>
                              <div className="col" aria-hidden="true" style={{ position: 'absolute', left: '191.59%' }}><a><img src="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2-300x200.jpg" data-src="https://nhaxinh.com/wp-content/uploads/2022/05/Sofa-Miami-2-cho-vai-xam-2-300x200.jpg" alt="" width="300" height="" className="attachment-woocommerce_thumbnail lazy-load-active" /></a></div>
                            </div>
                          </div>
                      ...
                      <a href="/" data-flickity-el=".product-gallery-slider" data-action="next" className="next_arrow desktop"><img src="https://nhaxinh.com/wp-content/themes/flatsome-child/assets/images/arrowdown.svg" alt="next" /></a>
                    </div>
                  </div>
                  ...
                  <div className="product-info summary col-fit col entry-summary product-summary">
                        ...
                        <div className="wishlist-popup dark">
                          ...
                          <div className="yith-wcwl-add-to-wishlist add-to-wishlist-34192  wishlist-fragment on-first-load" data-fragment-ref="34192" data-fragment-options="{&quot;base_url&quot;:&quot;&quot;,&quot;in_default_wishlist&quot;:false,&quot;is_single&quot;:true,&quot;show_exists&quot;:false,&quot;product_id&quot;:&quot;34192&quot;,&quot;parent_product_id&quot;:&quot;34192&quot;,&quot;product_type&quot;:&quot;simple&quot;,&quot;show_view&quot;:true,&quot;browse_wishlist_text&quot;:&quot;Browse wishlist&quot;,&quot;already_in_wishslist_text&quot;:&quot;The product is already in your wishlist!&quot;,&quot;product_added_text&quot;:&quot;Product added!&quot;,&quot;heading_icon&quot;:&quot;fa-heart-o&quot;,&quot;available_multi_wishlist&quot;:false,&quot;disable_wishlist&quot;:false,&quot;show_count&quot;:false,&quot;ajax_loading&quot;:false,&quot;loop_position&quot;:&quot;after_add_to_cart&quot;,&quot;item&quot;:&quot;add_to_wishlist&quot;}">
                            ...
                            <div className="yith-wcwl-add-button">
                              <a href="?add_to_wishlist=34192&amp;_wpnonce=32c7a78387" className="add_to_wishlist single_add_to_wishlist" data-product-id="34192" data-product-type="simple" data-original-product-id="34192" data-title="Add to wishlist" rel="nofollow">
                    ...
                    <div className="product-attributes-wrapper">
                      <div className="product-attribute product-attribute-item product-attribute-item-0">
                        <strong>Material</strong>
                        <span className="product-attribute-option">Khung gỗ bọc vải - nệm ngồi có thể tháo rời vỏ</span>
                      </div>

                      <div className="product-attribute product-attribute-item product-attribute-item-0">
                        <strong>Kích thước</strong>
                        <span className="product-attribute-option">D1700 - R850 - C770 mm</span>
                      </div>
                    ...
                    <div className="product_meta">
                      ...
                      <span className="sku_wrapper">
                        ...
                        <span className="sku">3*106229</span>
                      </span>

                      <span className="posted_in">
                        Danh mục:

                        <a href="https://nhaxinh.com/danh-muc/phong-khach/" rel="tag">Phòng khách</a>
                        ,
                        <a href="https://nhaxinh.com/danh-muc/phong-khach/sofa/" rel="tag">Sofa</a>
                      </span>

                    </div>
                    <p className="stock in-stock">In stock</p>

                    <form className="cart" action="https://nhaxinh.com/san-pham/sofa-miami-2-cho-vai-xam/" method="post" encType="multipart/form-data">

                      <div className="quantity buttons_added">
                        <input type="button" value="-" className="minus button is-form" />
                        <label className="screen-reader-text" htmlFor="quantity_657322ea2e9d8">Sofa Miami 2 chỗ vải xám quantity</label>
                        <input type="number" id="quantity_657322ea2e9d8" className="input-text qty text" step="1" min="1" max="2" name="quantity" value="1" title="Qty" size="4" placeholder="" inputMode="numeric" />
                        <input type="button" value="+" className="plus button is-form" />
                      </div>
                      <a href="https://nhaxinh.com/gio-hang/?add-to-cart=34192" className="buy-now button">Mua ngay</a>
